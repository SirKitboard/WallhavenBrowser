...
import com.sirkitboard.wallhavenbrowser.util.RetainFragment;
import com.sirkitboard.wallhavenbrowser.util.WallhavenImageCache;

import java.lang.ref.WeakReference;

public class DispatchActivityCacheBackup extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageCache = retainFragment.mRetainedCache;
		if (imageCache == null) {
